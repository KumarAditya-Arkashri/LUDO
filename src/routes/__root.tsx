    ...
    return (
      <div className="fixed bottom-0 w-full max-w-[480px] border-t bg-primary px-4 py-3 pb-safe z-50">
        <div className="flex items-center justify-between text-white">
          <Link to="/" className="flex flex-col items-center gap-1 opacity-100 hover:opacity-100">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            <span className="text-[10px]">Home</span>
          </Link>
          <Link to="/" className="flex flex-col items-center gap-1 opacity-70 hover:opacity-100">
