...
export const SOCKET_EVENTS = {
  ...
  createPrivateBattle: "CREATE_PRIVATE_BATTLE",
  privateBattleCreated: "PRIVATE_BATTLE_CREATED",
  joinPrivateBattle: "JOIN_PRIVATE_BATTLE",
  privateBattleJoined: "PRIVATE_BATTLE_JOINED",
  cancelPrivateBattle: "CANCEL_PRIVATE_BATTLE",
  privateBattleCancelled: "PRIVATE_BATTLE_CANCELLED",
  privateBattleExpired: "PRIVATE_BATTLE_EXPIRED",
